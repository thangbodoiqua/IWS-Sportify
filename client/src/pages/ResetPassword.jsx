...
<form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
      ...
      <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
        ...
        <input
          ...
          className='bg-transparent outline-none text-white flex-grow' // Thêm flex-grow để input chiếm không gian còn lại
          value={newPassword}
          onChange={e => setNewPassword(e.target.value)}
          required
        />
        <button
          type="button" // Ngăn submit form khi click vào nút con mắt
          className='cursor-pointer focus:outline-none'
          onClick={togglePasswordVisibility}
        >
          <img
            src={showPassword ? assets.eye_solid : assets.eye_slash_solid} // Sử dụng icon con mắt mở/đóng
