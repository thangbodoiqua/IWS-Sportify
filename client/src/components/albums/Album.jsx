...
const Album = ({ album, onBack }) => {
    const { setCurrentSong, playPlaylist, setIsPlaying } = useContext(AppContext).value; // Lấy setIsPlaying
    ...
    const handleSongSelect = (song) => {
        setCurrentSong(song);
        setIsPlaying(true); // Gọi setIsPlaying khi chọn một bài hát
    };
        ...
        <div className="text-white bg-gradient-to-b from-neutral-800 to-black p-4 rounded-lg relative">
            ...
            <div className="flex items-center gap-4 mb-6">
                <button
                    ...
                    onClick={() => playPlaylist(songs)} // Hàm này có thể đã xử lý việc phát nhạc
                >
                        ...
                        {songs.map((song, index) => (
                            ...
                            >
                                <div
                                    ...
                                    onClick={() => handleSongSelect(song)} // Gọi handleSongSelect khi click
                                >
